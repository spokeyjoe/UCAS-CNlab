...
if __name__ == '__main__':
    ...
    r1.cmd('route add -net 10.0.5.0 netmask 255.255.255.0 gw 10.0.3.2 dev r1-eth1')
    ...
    r2.cmd('route add -net 10.0.2.0 netmask 255.255.255.0 gw 10.0.4.2 dev r2-eth1')
    ...
    r4.cmd('ifconfig r4-eth1 10.0.2.1/24')
    r4.cmd('route add -net 10.0.1.0 netmask 255.255.255.0 gw 10.0.5.1 dev r4-eth0')
    r4.cmd('route add -net 10.0.3.0 netmask 255.255.255.0 gw 10.0.5.1 dev r4-eth0')
    r4.cmd('route add -net 10.0.4.0 netmask 255.255.255.0 gw 10.0.5.1 dev r4-eth0')
